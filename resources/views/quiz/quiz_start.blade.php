    ...
    <div class="row g-3 mx-3 second-child-box">
        ...
        <div class="col-md-3 first-childd">
            <div class="left-image height-fixed">
                <div class="my-slider">
                    <div class="img-slider"><img src="{{asset('assets/images/left-side.jpg')}}" alt="Left Side Image 1"
                            class="img-fluid"></div>
                    <div class="img-slider"><img src="{{asset('assets/images/left-side1.jpg')}}" alt="Left Side Image 2"
                            class="img-fluid"></div>
                    <div class="img-slider"><img src="{{asset('assets/images/left-side2.jpg')}}" alt="Left Side Image 3"
                            class="img-fluid"></div>
                    <div class="img-slider"><img src="{{asset('assets/images/left-img-3.jpg')}}" alt="Left Side Image 4"
                            class="img-fluid"></div>
                </div>
            </div>
        </div>
        ...
        <div class="text-center col-md-6 second-childd">
            <div class="map login-form text-center">
                <form action="{{ route('storeUser') }}" method="post" id="registrationForm">
                    @csrf
                    <label for="name">Name <span class="text-danger error">*</span></label>
                    <input type="text" id="name" name="name" placeholder="Enter your name"
                        oninput="validateInputChar(this)">

                    <label for="age">Age <span class="text-danger error">*</span></label>
                    <input type="text" id="age" name="age" placeholder="Enter your age" oninput="validateInput(this)"
                        maxlength="3">

                    <label for="mobile">Mobile Number <span class="text-danger error">*</span></label>
